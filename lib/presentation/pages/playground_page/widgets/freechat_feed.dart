...
import 'package:app/presentation/pages/sub_pages/freechat_screen.dart';
...
class FreeChatFeed extends ConsumerWidget {
  const FreeChatFeed({super.key});
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const FreeChatScreen(),
                ),
              );
            },
            child: Hero(
