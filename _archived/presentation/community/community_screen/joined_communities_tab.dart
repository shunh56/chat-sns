...
class JoinedCommunitiesTab extends ConsumerWidget {
  const JoinedCommunitiesTab({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final popularCommunitiesAsync = ref.watch(joinedCommunitiesProvider);
